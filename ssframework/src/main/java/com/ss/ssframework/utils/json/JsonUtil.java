package com.ss.ssframework.utils.json;
 ...
 * Created by 健 on 2017/8/3.
 */

public class JsonUtil {

    private static volatile Gson INSTANCE_GSON;
    public static Gson gson() {
        if (INSTANCE_GSON == null) {
            synchronized (JsonUtil.class) {
                if (INSTANCE_GSON == null) {
                    INSTANCE_GSON = new Gson();
                }
            }
        }
        return INSTANCE_GSON;
    }
    ...
    public static String toJson(Object obj) {
        return INSTANCE_GSON.toJson(obj);
    }
    ...
    public static <T> T fromJson(String str, Class<T> type) {
        return INSTANCE_GSON.fromJson(str, type);
    }
